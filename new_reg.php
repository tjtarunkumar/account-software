...
$headers .= 'From: '.$from."\r\n".
    ...
    'X-Mailer: PHP/';
$message = '<html><body>';
$message .= '<h1 style="color:#f40;">welcome!</h1>';
$message .= '<p style="color:#080;font-size:18px;">to the kumar website</p>';
$message .= '</body></html>';
...
$args1 = array(
 ...
 foreach ($subscribers as $user) 
 {
	 ...
	 $ue=$user->user_email;
	 wp_mail( $ue,$subject,$message,$headers);
