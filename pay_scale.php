...
<form class='w3-container'>
	 ...
	 <p><label>Minimum</label>
		 <input class='w3-input' type='text' name='minimum' value='$minimum'>
	 </p>$errors[minimum]
	 
	 <p><label>Grade Pay</label>
	     <input class='w3-input' type='text' name='grade_pay' value='$grade_pay'>
	 </p>$errors[grade_pay]
	 
	 <p><label>Maximum</label>
		 <input class='w3-input' type='text' name='maximum' value='$maximum'>
	 </p>$errors[maximum]
	 
	 <p><label>Name of Pay</label>
	     <input class='w3-input' type='text' name='pay_name' value='$pay_name'>
	 </p>$errors[pay_name]
	 
	 <p><label>Entry Pay Band</label>
	     <input class='w3-input' type='text' name='entry_pay' value='$entry_pay'>
	 </p>$errors[entry_pay]
